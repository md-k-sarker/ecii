...
//     * @return
//     */
//    public boolean sortSolutionsCustom(ArrayList<CandidateSolution> candidateSolutions, boolean ascendingOfStringLength) {
//
//        candidateSolutions.sort(new Comparator<CandidateSolution>() {
//            @Override
